...
class TopologicalMacroGNN(nn.Module):
    def __init__(self, node_in_channels=5, edge_in_channels=14, hidden_channels=128):
        ...
        # 4. Relative Direction Head (soft-constraint gating)
        # Two logits per edge for the sorted pair (a, b):
        #   logit 0: P(b right-of a), logit 1: P(b below-of a)
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        Returns (dist_norm_pred [E,1], dir_logits [E,2]).
        """
        ...
        # Predict relative direction (sorted pair order)
        dir_logits = self.direction_head(edge_repr)

        return dist_norm_pred, dir_logits
