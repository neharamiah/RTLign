...
| **RTL — SweRV EH1** | Floorplanned | **1 Initial DEF** (0 Swept Placements) | Initial synthesized `floorplan.def` (927 MB, 2.1M instances) in `generated_rtl_dataset/swerv/`; excluded from parameter sweeps due to memory/time scale. | **927 MB** |
